 ...
 * This should contain 
 */
function RelationsOperation(wallet) {
  try{
...
RelationsOperation.prototype = new Operation();

RelationsOperation.prototype.setType = function(type) {
  try{
...
RelationsOperation.prototype.setCounterparty = function(counterparty) {
  try{
...
RelationsOperation.prototype.setAmount = function(amount) {
  try{
    if (!isAmount(amount))
...
RelationsOperation.prototype._payload = function() {
...
*/
RelationsOperation.prototype._getOperation = function() {
  //Just check if the required parameters are empty
  try{
    if (!this._type || !this._counterparty || !this._amount)
      throw new ParamException("Please set params first!");
...
module.exports = RelationsOperation;
